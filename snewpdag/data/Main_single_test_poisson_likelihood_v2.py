...
PoissonLagLikelihood_v2 ==> Calculate the likelihood for a certain histogram pair using the speed-up algorithm
...
PoissonLagLikelihood = load_plugin('PoissonLagLikelihood_v2.py').PoissonLagLikelihood_v2
